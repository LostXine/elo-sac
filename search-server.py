...
def run():
    ...
    parser.add_argument('--path', type=str, help='where to save search result file (default: evol_rl.npy)', default='./save_server/evol_rl.npy')
    parser.add_argument('--log', type=str, help='where to save log file (default: evol_rl.log)', default='./save_server/evol_rl.log')
